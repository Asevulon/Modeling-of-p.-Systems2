...
// Modeling of p. Systems2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CModelingofpSystems2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CModelingofpSystems2App

CModelingofpSystems2App::CModelingofpSystems2App()
{
...
// Единственный объект CModelingofpSystems2App

CModelingofpSystems2App theApp;


// Инициализация CModelingofpSystems2App

BOOL CModelingofpSystems2App::InitInstance()
{
